...
| Project | Description |
|---|---|
| 🧮 **Calculator** | Supports +, −, ×, ÷ using if/elif control flow. *🗺️ Roadmap: add a Tkinter GUI.* |
...
| Project | Description |
|---|---|
| 🔐 **Account** | Basic admin login with hardcoded credentials. *⚠️ Early experiment — not secure by design.* |
...
- [ ] 🖥️ Add a Tkinter GUI to the Calculator
- [ ] 🛡️ Add try/except error handling across all scripts
